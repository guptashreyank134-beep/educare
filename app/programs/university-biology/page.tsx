...
export async function generateMetadata() {
  ...
  return getMetadata(data, "https://www.drshreyankeducare.com/programs/university-biology");
}
...
export default async function UniversityBiologyPage() {
  ...
  const faqs = await getProgramFaqs("university-biology");
  ...
  return (
    <>
      <JsonLd schema={getPageSchema(data, "https://www.drshreyankeducare.com/programs/university-biology")} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-12 lg:gap-20 mt-10 items-start">
          ...
          <div>
            <h1 className="text-[28px] sm:text-[36px] lg:text-[42px] font-bricolage font-normal text-slate leading-tight mb-[18px]">
              University Biology Tutoring in Vancouver
            </h1>
