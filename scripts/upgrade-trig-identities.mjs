...
const body = [
  ...
  h2("The double-angle identities"),
  p("These are the ones students most often mix up, because there are three versions of the cosine one:"),
  math(String.raw`\sin 2\theta = 2\sin\theta\cos\theta`),
